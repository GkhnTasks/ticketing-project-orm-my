...
public class ProjectController {
    ...
    public ResponseEntity<ResponseWrapper> getProjects() {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Projects are successfully retrived", projectDTOList, HttpStatus.OK));
    }
    ...
    public ResponseEntity<ResponseWrapper> deleteProject(@PathVariable("projectCode") String projectCode){
        ...
        return ResponseEntity.status(HttpStatus.NO_CONTENT).body(new ResponseWrapper("Project is successfully deleted",HttpStatus.CREATED));
        //204 NO_CONTENT
    }
